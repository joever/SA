 ...
 */
package com.ufes.app1.dao;

import com.ufes.app1.jdbc.ConnectionFactory;
...
public class SaidaRedeDAO {
    ...
    public List<SaidaRede> getSaidasRede(Integer idRede, Integer idTM, String idUsuario) {
        List<SaidaRede> mySaidasRede = new ArrayList<>();
        String sql = "select * from saidarede where idrede = ? and idtm = ? and idusuario = ?";
        try (PreparedStatement stmt = connection.prepareStatement(sql)){
