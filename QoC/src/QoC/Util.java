...
public class Util {
    ...
    private static CategoryDataset createDataset(int nRegistro, String nTabela, int cTipo, String Periodo[]) throws ParseException {
        ...
        String valores[][];
        if (Periodo == null)
            valores = BancoUtil.cTabela(nTabela,cTipo,nRegistro);
        else
            valores = BancoUtil.cTabela(nTabela,cTipo,nRegistro,Periodo);
        if (valores != null){
    ...
    private static DefaultPieDataset createPieDataset(int nRegistro, String nTabela, int cTipo, String Periodo[]) throws ParseException {
        ...
        String valores[][];
        if (Periodo == null)
            valores = BancoUtil.cTabela(nTabela,cTipo,nRegistro,true);
        else
            valores = BancoUtil.cTabela(nTabela,cTipo,nRegistro,true,Periodo);
        if (valores != null){
            while (i < valores.length) {
    ...
    private static CategoryDataset createDatasetM(int nRegistro, String nTabela, int cTipo, boolean metricas[], String Periodo[]) throws ParseException {
        ...
        String valores[][];
        if (Periodo == null)
            valores = BancoUtil.cTabelaMetricas(nTabela,cTipo,nRegistro);
        else
            valores = BancoUtil.cTabelaMetricas(nTabela,cTipo,nRegistro,Periodo);
        if (valores != null){
            while (i < valores.length) {
                if (metricas[0])
